...
@tool
def list_issue_transition_options(issue_key,server_url='https://biometrid.atlassian.net/'):
...
@tool
def update_issue_status(issue_key, target_status_name, server_url='https://biometrid.atlassian.net/'):
...
@tool
def create_issue(summary, description, issue_type, project_key='ML', server_url='https://biometrid.atlassian.net/'):
...
@tool
def delete_issue(issue_key, server_url='https://biometrid.atlassian.net/'):
...
@tool
def update_issue_summary(issue_key, summary, server_url='https://biometrid.atlassian.net/'):
...
@tool
def update_issue_description(issue_key, description, server_url='https://biometrid.atlassian.net/'):
...
@tool
def view_issue(issue_key, server_url='https://biometrid.atlassian.net/'):
