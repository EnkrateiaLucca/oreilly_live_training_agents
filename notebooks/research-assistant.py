...
search_question_chain = SEARCH_PROMPT | ChatOpenAI(temperature=0, model="gpt-3.5-turbo-1106") | StrOutputParser() | json.loads
...
research_report = chain.invoke({"question": sys.argv[1]})
